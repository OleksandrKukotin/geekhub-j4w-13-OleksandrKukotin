...
class ContentValidatorTest {
    ...
    @Test
    void isValid_WhenLinkWithoutContent_ShouldThrowException() throws MalformedURLException {
        ContentValidator validator = new ContentValidator(MAX_FILE_SIZE);
    ...
    @Test
    void isValid_WhenFileSizeMoreThanLimit_ShouldThrowException() throws MalformedURLException {
        ContentValidator validator = new ContentValidator(10);
        URL url = new URL(PATH_TO_FILE);

        LimitSizeException exception = assertThrows(LimitSizeException.class, () ->
            validator.isValid(url, PATH_TO_FILE, FILE_NAME));
